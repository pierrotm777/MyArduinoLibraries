...
class NazaCanDecoderLib
{
  public:
    ...
    typedef enum { MOTOR_M1 = 0, MOTOR_M2 = 1, MOTOR_M3 = 2, MOTOR_M4 = 3, MOTOR_M5 = 4, MOTOR_M6 = 5, MOTOR_F1 = 6, MOTOR_F2 = 7 } motorOut_t;  // Motor output index
    ...
    uint16_t getMotorOut(motorOut_t mot); // Returns motor output value (0 when unused, otherwise 16920~35000, 16920 = motor off), use motorOut_t enum to index the table
