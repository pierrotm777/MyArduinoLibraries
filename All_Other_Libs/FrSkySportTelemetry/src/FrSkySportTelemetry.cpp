/*
  FrSky telemetry class for Teensy LC/3.x/4.x, ESP32, ESP8266, ATmega2560 (Mega) and ATmega328P based boards (e.g. Pro Mini, Nano, Uno)
  (c) Pawelsky 20210108
                                ...
                                FrSkySportSensor* sensor28)
{
  ...
  FrSkySportTelemetry::serial.begin(id, rxPin, txPin);
}
#endif
