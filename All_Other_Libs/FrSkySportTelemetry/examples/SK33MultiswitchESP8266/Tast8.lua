...
local timeprevhelp								-- Abgelaufene Zeit
...
local function background()
   if not running then
	...
	if timenowsys - timeprev > 20 then 					-- more than 200 msec since previous run 
	timeprev = timenowsys
   ...
   -- Auswahlauswertung und Zeitliches setzen von GV1 bzw. GV2
	...
	if status[1]==1 and var1 == 0 then								-- Status Feld 1 auswerten, Hilfsvariable auf 0 abfragen
		...
		timeprevhelp = getTime();								-- Timer starten
		var1 = 1										-- Hilfsvariable für weitere Bearbeitung setzen
	
	elseif status[1]==1 and var1 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
	...
	elseif status[1]==0 and var1 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[2]==1 and var2 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. wieder auf 0% setzen
		var2 = 2		
	...
	elseif status[2]==0 and var2 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[3]==1 and var3 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. wieder auf 0% setzen
		var3 = 2		
	...
	elseif status[3]==0 and var3 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[4]==1 and var4 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. wieder auf 0% setzen
		var4 = 2		
	...
	elseif status[4]==0 and var4 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[5]==1 and var5 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
	...
	elseif status[5]==0 and var5 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[6]==1 and var6 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. wieder auf 0% setzen
		var6 = 2		
	...
	elseif status[6]==0 and var6 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[7]==1 and var7 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. wieder auf 0% setzen
		var7 = 2		
	...
	elseif status[7]==0 and var7 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[8]==1 and var8 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. wieder auf 0% setzen
		var8 = 2		
	...
	elseif status[8]==0 and var8 == 2 then								-- Auswertung Status auf 0, Variable
		model.setGlobalVariable(0,0,100);							-- GV1 auf 100% setzen
		timeprevhelp = getTime();								-- Timer starten
		var8 = 3;										-- Hilfsvariable für weitere Bearbeitung setzen

	elseif status[8]==0 and var8 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(0,0,0);								-- GV1 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[9]==1 and var9 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
	...
	elseif status[9]==0 and var9 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[10]==1 and var10 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. wieder auf 0% setzen
		var10 = 2		
	...
	elseif status[10]==0 and var10 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[11]==1 and var11 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. wieder auf 0% setzen
		var11 = 2		
	...
	elseif status[11]==0 and var11 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[12]==1 and var12 == 1 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. wieder auf 0% setzen
		var12 = 2		
	...
	elseif status[12]==0 and var12 == 3 and (timenow - timeprevhelp > 100) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 1 Sec. Wieder auf 0% setzen
	...
	elseif status[13]==1 and var13 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
	...
	elseif status[13]==0 and var13 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[14]==1 and var14 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. wieder auf 0% setzen
		var14 = 2		
	...
	elseif status[14]==0 and var14 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. Wieder auf 0% setzen
	...
	elseif status[15]==1 and var15 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. wieder auf 0% setzen
		var15 = 2		
	...
	elseif status[15]==0 and var15 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. Wieder auf 0% setzen
	...
	if status[16]==1 and var16 == 0 then								-- Status Feld 15 auswerten, Hilfsvariable auf 0 abfragen
		model.setGlobalVariable(1,0,40);							-- GV2 auf 40% setzen
		timeprevhelp = getTime();								-- Timer starten
		var16 = 1										-- Hilfsvariable für weitere Bearbeitung setzen
	
	elseif status[16]==1 and var16 == 1 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. wieder auf 0% setzen
		var16 = 2		
	...
	elseif status[16]==0 and var16 == 3 and (timenow - timeprevhelp > 300) then 			-- Auswertung Status auf0, Variable, Abgelaufene Zeit
		model.setGlobalVariable(1,0,0);								-- GV2 nach 3 Sec. Wieder auf 0% setzen
...
lcd.clear()
   ...
   elseif( event ==  98) and (model.getGlobalVariable(0,0)== 0) and (model.getGlobalVariable(1,0)==0) then cpress = 1 else cpress = 0 	-- 98 / Taste ENT
  end
