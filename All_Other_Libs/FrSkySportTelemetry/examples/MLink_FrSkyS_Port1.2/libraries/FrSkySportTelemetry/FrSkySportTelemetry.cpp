...
bool FrSkySportTelemetry::begin(FrSkySportSingleWireSerial::SerialId id,
                                ...
                                FrSkySportSensor* sensor28)
{
  ...
  if(sensorCount >= FRSKY_TELEMETRY_MAX_SENSORS) return false;
...
void FrSkySportTelemetry::reInit(FrSkySportSensor* sensor1,  FrSkySportSensor* sensor2,  FrSkySportSensor* sensor3,
                                FrSkySportSensor* sensor4,  FrSkySportSensor* sensor5,  FrSkySportSensor* sensor6,
                                FrSkySportSensor* sensor7,  FrSkySportSensor* sensor8,  FrSkySportSensor* sensor9,
                                FrSkySportSensor* sensor10, FrSkySportSensor* sensor11, FrSkySportSensor* sensor12,
                                FrSkySportSensor* sensor13, FrSkySportSensor* sensor14, FrSkySportSensor* sensor15,
...
void FrSkySportTelemetry::send(byte rssi)
{
  if(serial.port != NULL)
  {
    ...
    {
      polledId = pollingClass->pollData(serial, now,rssi);
    }
    else
    {
