...
class SoftwareSerial : public Stream {
  ...
  private:
    ...
    //  m_bitCycles  :  FS ++++++   used in reading part.(ISR). For ESP32C3 containts the period en micro sec
    //    for others contains the nbr of cpu cycles per bit
    uint32_t m_bitCycles;
    // m_bitCyclesWrite :FS ++++   used for generation of pulse when writing. ALways contain nbr of CPU cycle
    uint32_t m_bitCyclesWrite;
