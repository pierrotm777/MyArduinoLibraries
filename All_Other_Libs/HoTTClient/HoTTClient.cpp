...
*/
	...
	switch (telemetryData[1]) {
		case HOTT_ELECTRIC_AIR_MODULE_ID:
			...
			cellVoltage1 = telemetryData[6] / 100.0 * 2;
			cellVoltage2 = telemetryData[7] / 100.0 * 2;
			cellVoltage3 = telemetryData[8] / 100.0 * 2;
			cellVoltage4 = telemetryData[9] / 100.0 * 2;
			cellVoltage5 = telemetryData[10] / 100.0 * 2;
			cellVoltage6 = telemetryData[11] / 100.0 * 2;
			cellVoltage7 = telemetryData[12] / 100.0 * 2;
			cellVoltage8 = telemetryData[13] / 100.0 * 2;
			cellVoltage9 = telemetryData[14] / 100.0 * 2;
			cellVoltage10 = telemetryData[15] / 100.0 * 2;
			cellVoltage11 = telemetryData[16] / 100.0 * 2;
