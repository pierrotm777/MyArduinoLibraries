...
* 20/03/2022: In TinyPinChange_UnregisterIsr(), clear Isr to allow a registration of a previously removed ISR
*             TINY_PIN_CHANGE_VERSION and TINY_PIN_CHANGE_REVISION added (starting at V1.0)
*/
#define TINY_PIN_CHANGE_VERSION                    1
#define TINY_PIN_CHANGE_REVISION                   0
