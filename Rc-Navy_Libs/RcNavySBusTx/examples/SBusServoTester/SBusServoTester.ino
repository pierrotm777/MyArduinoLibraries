...
void setup()
{
  ...
  SBusTx.serialAttach(&Serial, SBUS_TX_NORMAL_FRAME_RATE_MS); /* Attach the SBUS generator to the Serial with SBUS_TX_NORMAL_FRAME_RATE_MS or SBUS_TX_HIGH_SPEED_FRAME_RATE_MS */
}

void loop()
{ 
  SBusTx.process(); /* Do not forget to call this for updating Synchro */
