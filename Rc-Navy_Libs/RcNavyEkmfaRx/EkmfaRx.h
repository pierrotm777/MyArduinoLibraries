...
class EkmfaRxClass
{
  ...
  public:
    ...
    void                 setPreferencesNamespace(const char *Namespace); /* ESP32 only: Preferences namespace, useful when several EkmfaRxClass instances are used. AVR/Teensy: ignored for sketch portability. */
#if (EKMFA_RX_DEBUG > 0)
